...
func Deploy(log logger.Logger, chainId *big.Int, client *ethclient.Client, privKey *ecdsa.PrivateKey, mpcCoordinatorAddr *common.Address) (*common.Address, *AvaLido, error) {
	...
	addr, tx, avalido, err := DeployAvaLido(signer, client, *mpcCoordinatorAddr)
