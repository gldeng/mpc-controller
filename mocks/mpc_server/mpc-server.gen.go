// mpc-server-mock v0.0.1 8b46419ae84da6e956f9eaf1e8e084d2fef7bb0a
// --
...
func WebRPCSchemaHash() string {
	return "8b46419ae84da6e956f9eaf1e8e084d2fef7bb0a"
}
...
type mPCServiceServer struct {
	MPCService
}

func NewMPCServiceServer(svc MPCService) WebRPCServer {
	return &mPCServiceServer{
		MPCService: svc,
	}
}

func (s *mPCServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "MPCService")
	...
	switch r.URL.Path {
	case "/keygen":
		s.serveKeygen(ctx, w, r)
		return
	case "/sign":
		s.serveSign(ctx, w, r)
		return
	case "/result":
		s.serveResult(ctx, w, r)
		return
	default:
...
func (s *mPCServiceServer) serveKeygen(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *mPCServiceServer) serveKeygenJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Keygen")
	reqContent := struct {
		Arg0 *KeygenRequest `json:"keygenReq"`
	}{}
	...
	func() {
		...
		err = s.MPCService.Keygen(ctx, reqContent.Arg0)
	}()
...
func (s *mPCServiceServer) serveSign(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *mPCServiceServer) serveSignJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Sign")
	reqContent := struct {
		Arg0 *SignRequest `json:"signReq"`
	}{}
	...
	func() {
		...
		err = s.MPCService.Sign(ctx, reqContent.Arg0)
	}()
...
func (s *mPCServiceServer) serveResult(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *mPCServiceServer) serveResultJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Result")
	reqContent := struct {
		Arg0 string `json:"reqID"`
	}{}
	...
	func() {
		...
		ret0, err = s.MPCService.Result(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *Result `json:"result"`
	}{ret0}
...
const MPCServicePathPrefix = "/rpc/MPCService/"
...
func NewMPCServiceClient(addr string, client HTTPClient) MPCService {
	prefix := urlBase(addr) + MPCServicePathPrefix
	urls := [3]string{
		prefix + "Keygen",
		prefix + "Sign",
		prefix + "Result",
	}
	return &mPCServiceClient{
		client: client,
		urls:   urls,
	}
}

func (c *mPCServiceClient) Keygen(ctx context.Context, keygenReq *KeygenRequest) error {
	in := struct {
		Arg0 *KeygenRequest `json:"keygenReq"`
	}{keygenReq}
...
func (c *mPCServiceClient) Sign(ctx context.Context, signReq *SignRequest) error {
	in := struct {
		Arg0 *SignRequest `json:"signReq"`
	}{signReq}
...
func (c *mPCServiceClient) Result(ctx context.Context, reqID string) (*Result, error) {
	in := struct {
		Arg0 string `json:"reqID"`
	}{reqID}
	out := struct {
