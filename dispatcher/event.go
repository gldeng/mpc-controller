...
func NewRootEventObject(createdBy string, evt Event, ctx context.Context) *EventObject {
	return NewEventObject(AddEventStreamCount(), NewID(), uint64(0), "", 0,
		createdBy, evt, ctx)
}
...
func NewEventObject(evtStreamNo uint64, evtStreamID string, parentEvtNo uint64, parentEvtID string, parentEvtStep int,
