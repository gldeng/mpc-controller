...
cast send --rpc-url $C_CHAIN_RPC_URL --from $ROLE_PROTOCOL_MANAGER --private-key $ROLE_PROTOCOL_MANAGER_PK --gas-limit 900000 $AVALIDO "setMaxProtocolControlledAVAX(uint256)" 50000000000000000000000000 > /dev/null
