...
echo -n addr > /tmp/mpctest/contracts/addresses/LAST_GEN_ADDRESS
...
cast send --rpc-url $C_CHAIN_RPC_URL --from $ROLE_DEFAULT_ADMIN --private-key $ROLE_DEFAULT_ADMIN_PK --value 1000ether $AVALIDO_ADDRESS > /dev/null
