...
$AVALANCHEGO_REPO/build/avalanchego --public-ip=127.0.0.1 --http-port=9650 --staking-port=9651 --db-dir=db/node1 --network-id=local --staking-tls-cert-file=$AVALANCHEGO_REPO/staking/local/staker1.crt --staking-tls-key-file=$AVALANCHEGO_REPO/staking/local/staker1.key > log/node1.log 2>&1 &
...
$AVALANCHEGO_REPO/build/avalanchego --public-ip=127.0.0.1 --http-port=9656 --staking-port=9657 --db-dir=db/node4 --network-id=local --bootstrap-ips=127.0.0.1:9651 --bootstrap-ids=NodeID-7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg --staking-tls-cert-file=$AVALANCHEGO_REPO/staking/local/staker4.crt --staking-tls-key-file=$AVALANCHEGO_REPO/staking/local/staker4.key > log/node4.log 2>&1 &

$AVALANCHEGO_REPO/build/avalanchego --public-ip=127.0.0.1 --http-port=9658 --staking-port=9659 --db-dir=db/node5 --network-id=local --bootstrap-ips=127.0.0.1:9651 --bootstrap-ids=NodeID-7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg --staking-tls-cert-file=$AVALANCHEGO_REPO/staking/local/staker5.crt --staking-tls-key-file=$AVALANCHEGO_REPO/staking/local/staker5.key > log/node5.log 2>&1 &
