...
////go:generate abigen --sol src/Treasury.sol --pkg contract --out Treasury.go --type Treasury
////go:generate abigen --sol src/MpcManager.sol --pkg contract --out MpcManager.go --type MpcManager
////go:generate abigen --sol src/OracleManager.sol --pkg oracle --out OracleManager.go --type OracleManager
