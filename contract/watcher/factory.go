...
func (f *Factory) NewWatcher(process watcher.Process, opts *bind.WatchOpts, name EvtName, queries ...[]interface{}) (*watcher.Watcher, error) {
	...
	case EvtParticipantAdded:
		logs, sub, err = f.BoundContract.WatchLogs(opts, string(EvtParticipantAdded), queries...)
		unpack = func(log types.Log) (interface{}, error) {
			myEvent := new(contract.MpcManagerParticipantAdded)
			if err := f.BoundContract.UnpackLog(myEvent, string(EvtParticipantAdded), log); err != nil {
	...
	case EvtKeygenRequestAdded:
		logs, sub, err = f.BoundContract.WatchLogs(opts, string(EvtKeygenRequestAdded), queries...)
		unpack = func(log types.Log) (interface{}, error) {
			myEvent := new(contract.MpcManagerKeygenRequestAdded)
			if err := f.BoundContract.UnpackLog(myEvent, string(EvtKeygenRequestAdded), log); err != nil {
	...
	case EvtKeyGenerated:
		logs, sub, err = f.BoundContract.WatchLogs(opts, string(EvtKeyGenerated), queries...)
		unpack = func(log types.Log) (interface{}, error) {
			myEvent := new(contract.MpcManagerKeyGenerated)
			if err := f.BoundContract.UnpackLog(myEvent, string(EvtKeyGenerated), log); err != nil {
	...
	case EvtStakeRequestAdded:
		logs, sub, err = f.BoundContract.WatchLogs(opts, string(EvtStakeRequestAdded), queries...)
		unpack = func(log types.Log) (interface{}, error) {
			myEvent := new(contract.MpcManagerStakeRequestAdded)
			if err := f.BoundContract.UnpackLog(myEvent, string(EvtStakeRequestAdded), log); err != nil {
	...
	case EvtRequestStarted:
		logs, sub, err = f.BoundContract.WatchLogs(opts, string(EvtRequestStarted), queries...)
		unpack = func(log types.Log) (interface{}, error) {
			myEvent := new(contract.MpcManagerRequestStarted)
			if err := f.BoundContract.UnpackLog(myEvent, string(EvtRequestStarted), log); err != nil {
