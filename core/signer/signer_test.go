...
func (suite *SignRequesterTestSuite) SetupTest() {
	suite.SignRequestArgs = SignRequestArgs{
		...
		NormalizedParticipantKeys: []string{"03d0639e479fa1ca8ee13fd966c216e662408ff00349068bdc9c6966c4ea10fe3e", "0373ee5cd601a19cd9bb95fe7be8b1566b73c51d3e7e375359c129b1d77bb4b3e6"},
		PubKeyHex:                 "0373ee8ae85eceeb6547a31ad6a5add1598f35964e1e3f0513bcde455f4c15b2de",
	}
}
...
func (suite *SignRequesterTestSuite) TestSignExportTx() {
	...
	exportTxSignReq := core.SignRequest{
		...
		PublicKey:       suite.PubKeyHex,
		ParticipantKeys: suite.NormalizedParticipantKeys,
		Hash:            hash,
	}
